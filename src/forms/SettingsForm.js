            ...
            <Form>
                    <Form.Row className="align-items-center">
                     ...
                     <Form.Group as={Col} controlId="formGridIncome">
                      ...
                      <Form.Control type="text" value={newIncome} onChange={handleIncomeChange} placeholder="Enter monthly income"/>
                    ...
                    <Form.Row className="align-items-center">
                        ...
                        <Form.Group as={Col} controlId="formExpenseDescription">
                            ...
                            <Form.Control type="text" value={newExpense} onChange={handleNewExpense} placeholder="Enter expense description" />
                            <Form.Text className="text-muted">
                        ...
                        <Form.Group as={Col} controlId="formExpenseAmount">
                            ...
                            <Form.Control type="number" value={newExpense} onChange={handleNewExpense} placeholder="Enter expense amount" />
                            <Form.Text className="text-muted">
